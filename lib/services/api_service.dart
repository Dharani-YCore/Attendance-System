...
class ApiService {
  ...
  static const String _localIpAddress = '192.168.41.191'; // For physical device
...
• Check firewall settings''';
  ...
  static Future<Map<String, dynamic>> login(String email, String password) async {
    try {
      ...
      final response = await http.post(
        ...
        onTimeout: () {
          throw Exception('Connection timeout. Please check your network configuration and ensure XAMPP server is running.');
        },
      );
  ...
  static Future<Map<String, dynamic>> testConnection() async {
    try {
      ...
      final testUrl = '$baseUrl/test_connection.php'; // Create a simple test file
      final response = await http.get(
        Uri.parse(testUrl),
        ...
        onTimeout: () {
          throw Exception('Connection timeout during test');
        },
      );
